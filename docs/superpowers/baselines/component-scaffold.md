# Baseline: component-scaffold

First run of `.claude/skills/component-scaffold/audit-components.ts` against
...
are the failure classes `sigil-audit` describes, now gated in the suite.
