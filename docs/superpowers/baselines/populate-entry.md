# Baseline: populate-entry

**Date:** 2026-08-05
**Skill:** `.claude/skills/populate-entry/`
**Script:** `bun .claude/skills/populate-entry/audit-entries.ts`
...
| All 920 character entries                                                                      | Covered by `populate-character` and ranked by `content-triage`. The audit deliberately excludes them.                                                          |
