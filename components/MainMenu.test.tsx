...
describe('MainMenu', () => {
  it('renders six tiles in order: Maps, Timeline, Houses, Characters, Weapons, Dragons', () => {
    render(<MainMenu />);
    ...
    expect(links[5].textContent).toContain('Dragons');
    expect(links[5].getAttribute('href')).toBe('/dragons/');
  });
