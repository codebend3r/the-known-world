...
// The shared line-art section glyphs, rendered in `currentColor` at 32x32.
// Consumed by the homepage `MainMenu`, the `SiteMenu` drawer, and the
// `PageHeading` title block so a section shows one consistent mark everywhere.
...
export function sectionGlyph(slug: SectionSlug): ReactNode {
  return sectionGlyphs[slug];
}
