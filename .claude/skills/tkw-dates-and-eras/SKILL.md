...
bun .claude/skills/tkw-dates-and-eras/audit-dates.ts

# one collection: battles castles characters dragons events houses weapons
bun .claude/skills/tkw-dates-and-eras/audit-dates.ts --collection houses

# machine-readable, for batching repairs
bun .claude/skills/tkw-dates-and-eras/audit-dates.ts --json
...
- `docs/superpowers/baselines/tkw-dates-and-eras.md`: the 99-defect baseline run and how each correction was sourced
- `docs/superpowers/specs/2026-07-03-vertical-timeline-design.md`: why `absoluteYear` exists and what the y-axis does with it
- `tkw-populate-character` and `tkw-populate-house`: the AWOIAF pipeline for sourcing a date in the first place
