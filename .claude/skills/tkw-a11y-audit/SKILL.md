...
# audit
bun .claude/skills/tkw-a11y-audit/audit-a11y.ts
bun .claude/skills/tkw-a11y-audit/audit-a11y.ts --json | jq '.counts'
...
Baseline run and what it changed: `docs/superpowers/baselines/tkw-a11y-audit.md`.
...
- `tkw-image-optimize`: the same `public/` assets, sized rather than described
- `tkw-seo-metadata`: the other half of what a crawler and a screen reader share, `lang`, headings, and landmarks
