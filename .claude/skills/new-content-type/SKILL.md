...
bun .claude/skills/new-content-type/audit-wiring.ts
bun .claude/skills/new-content-type/audit-wiring.ts --json
...
- `content-triage`: what to populate once the collection is wired
- `sigil-audit`: the same silent-drift problem, for `public/sigils/`
- `image-optimize`: finds the dangling `/menu-icons/*.png` references this checklist can create
