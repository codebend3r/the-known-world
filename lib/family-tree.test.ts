  ...
  it("nests children under their in-house parent", () => {
    const people = [
      character({
        slug: "tytos",
        name: "Tytos",
        born: { year: 220, era: "AC", precision: "year" },
        died: null,
        "primary-house": "lannister",
        parents: [],
        spouses: [],
      ...
      character({
        slug: "tywin",
        name: "Tywin",
        born: { year: 242, era: "AC", precision: "year" },
        died: null,
        "primary-house": "lannister",
        parents: ["tytos"],
        spouses: [],
  ...
  it("renders an in-house spouse inline and does not duplicate them as a root", () => {
    const people = [
      ...
      character({
        slug: "aerys",
        name: "Aerys",
        born: { ...baseDate, year: 244 },
        died: null,
        "primary-house": "targaryen",
        parents: ["jaehaerys", "shaera"],
        spouses: [],
        children: [],
      }),
    ];
  ...
  it("propagates the first alias onto the TreeNode and external children", () => {
    const people = [
      character({
        ...
        spouses: ["rhaenys"],
        children: ["aenys"],
        aliases: ["The Conqueror", "The Dragon"],
      }),
      character({
        slug: "rhaenys",
  ...
  it("does not render the same person twice across siblings", () => {
    const people = [
      character({
        ...
        parents: [],
        spouses: ["unknown"],
        children: ["tytos", "father-of-joanna"],
      }),
      character({
        slug: "unknown",
        name: "Unknown",
      ...
      character({
        slug: "tytos",
        name: "Tytos",
        born: { ...baseDate, year: 220 },
        died: null,
        "primary-house": "lannister",
        parents: ["gerold", "unknown"],
        spouses: ["jeyne"],
        children: ["tywin"],
      }),
      character({
      ...
      character({
        slug: "joanna",
        name: "Joanna",
        born: { ...baseDate, year: 245 },
        died: null,
        "primary-house": "lannister",
        parents: ["father-of-joanna"],
        spouses: ["tywin"],
        children: [],
      }),
    ];
