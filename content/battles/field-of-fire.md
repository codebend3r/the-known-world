...
start:
  ...
  era: BC
  precision: exact
location: "the Reach, south of the Blackwater Rush"
region: reach
participants:
  - side: House Targaryen
    houses: [targaryen]
  - side: Lannister and Gardener host
    houses: [lannister, gardener]
commanders: [aegon-i-targaryen, loren-i-lannister, mern-ix-gardener]
