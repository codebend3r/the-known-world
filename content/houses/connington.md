...
seats:
  - name: Griffin's Roost
    slug: griffins-roost
heads:
  - name: "Ser Ronnet Connington"
    slug: ronnet-connington
    note: Knight of Griffin's Roost in name; the seat itself has been retaken in *A Dance with Dragons* by Lord Jon Connington for King Aegon VI
regions:
  - name: Stormlands
titles:
  - name: Lord of Griffin's Roost
    note: held by Lord Jon Connington until his attainder in 282 AC, then granted to a cadet line styled only "Knight of Griffin's Roost"; reclaimed by Jon for King Aegon VI in *A Dance with Dragons*
  - name: Knight of Griffin's Roost
    note: the diminished style imposed by King Robert I on the cadet line of Ronald Connington after the elder line's attainder
sources:
  - type: awoiaf
    url: https://awoiaf.westeros.org/index.php/House_Connington
